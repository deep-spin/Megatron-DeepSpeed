...
## The llama2 config uses stage=0...
zero_stage=1
...
data_path="/home/bpop/multilinguality_megatron/data-bin/data_text_document"

prescale_grad="true"
jobname="gpt_entmax_${model_size}B_tok${train_tokens_in_billion}B"
...
###############################################################################
tokenizer_path="/home/bpop/llama-tokenizer/tokenizer.model"
...
deepspeed pretrain_gpt.py \
    ...
    --loss-function entmax15 \
    --entmax-topk 512 &>> ${log_path}/${jobname}_${host}_${current_time}.log
